...
import { UpdateIssueRequest, UpdateVolumeManuallyRequest, Volume, VolumeService } from '../../core/services/volume.service';
...
@Component({
  ...
  imports: [
    ...
    ReactiveFormsModule, IconDirective
  ]
})
export class VolumeEditComponent {
